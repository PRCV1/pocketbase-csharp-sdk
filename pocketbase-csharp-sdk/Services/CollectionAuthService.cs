...
namespace pocketbase_csharp_sdk.Services
{
        ...
        where T : IBaseAuthModel
    {
        ...
        {
            var url = $"{BasePath()}/auth-methods";
            var response = client.Send<AuthMethodsList>(url, HttpMethod.Get, headers: headers, query: query, cancellationToken: cancellationToken);
            return response;
        }
        ...
        {
            var url = $"{BasePath()}/records/{HttpUtility.HtmlEncode(userId)}/external-auths";
            var result = client.Send<IEnumerable<ExternalAuthModel>>(url, HttpMethod.Get, headers: headers, query: query, cancellationToken: cancellationToken);
            return result;
        }
